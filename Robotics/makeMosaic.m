...
% Load images.
buildingDir = fullfile('/Users/marissadalonzo/Documents/MATLAB/mosaic/wall');
...
% Initialize features for I(1)
 ...
 [y,x, m] = harris(grayImage, 1000,'tile', [4 4],'disp', 'fft'); 
...
%% Step 4 - Create the Composite Panorama
% Use |imwarp| to map images into the panorama and use
% |vision.AlphaBlender| to overlay the images together.
