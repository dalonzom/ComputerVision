...
%                 size(X) > size(M),
%       'wrap'  - as for 'same' except that instead of using zero-padding
%                 the input A is taken to wrap round as on a toroid.
%
...
% David Young, COGS, University of Sussex, February 2002,
